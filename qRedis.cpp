...
float qRedis::hincrbyfloat(QString key, QString field, float increment)
{
...
QStringList qRedis::hkeys(QString key)
{
    QString cmd("HKEYS ");
    cmd.append(key);
...
QStringList qRedis::hmget(QString key, QString field)
{
    QString cmd("HMGET ");
    cmd.append(key);
...
bool qRedis::hmset(QString key, QMap<QString,QVariant> map)
{
    QString cmd("HMSET ");
    cmd.append(key);
...
bool qRedis::hset(QString key, QString field, QString value)
{
    QString cmd("HSET ");
    cmd.append(key);
...
bool qRedis::hsetnx(QString key, QString field, QString value)
{
    QString cmd("HSETNX ");
    cmd.append(key);
...
QStringList qRedis::hvals(QString key)
{
    QString cmd("HVALS ");
    cmd.append(key);
...
int qRedis::incrby(QString key,int interval)
{
    QString cmd("INCRBY ");
    cmd.append(key);
...
QStringList qRedis::keys(QString pattern)
{
    QString cmd("KEYS ");
    cmd.append(pattern);
...
int qRedis::lindex(QString key, int index)
{
    QString cmd("LINDEX ");
    cmd.append(key);
    cmd.append(" ");
...
int qRedis::linsert(QString key, QString position,
...
QString qRedis::lpop(QString key)
{
    QString cmd("LPOP ");
    cmd.append(key);
...
int qRedis::lpushx(QString key, QString value)
{
    QString cmd("LPUSHX ");
    cmd.append(key);
    cmd.append(" ");
...
QStringList qRedis::lrange(QString key, int start, int stop)
{
    QString cmd("LRANGE ");
    cmd.append(key);
    cmd.append(" ");
...
int qRedis::lrem(QString key, int count, QString value)
{
    QString cmd("LREM ");
    cmd.append(key);
    cmd.append(" ");
...
int qRedis::lset(QString key, int index, QString value)
{
    QString cmd("LSET ");
    cmd.append(key);
    cmd.append(" ");
...
bool qRedis::ltrim(QString key, int start, int stop)
{
    QString cmd("LTRIM ");
    cmd.append(key);
    cmd.append(" ");
...
QStringList qRedis::mget(QString key)
{
    QString cmd("MGET ");
        cmd.append(key);
...
bool qRedis::migrate(QString host, int port, QString key, int database, int timeout)
{
    QString cmd("MIGRATE ");
    cmd.append(host);
...
bool qRedis::move(QString key, int database)
{
    QString cmd("MOVE ");
    cmd.append(key);
...
bool qRedis::mset(QMap<QString, QVariant> map)
{
    QString cmd("MSET");
...
QVariant qRedis::object(QString subcommand, QString arguments)
{
    QString cmd("OBJECT ");
...
bool qRedis::persist(QString key)
{
    QString cmd("PERSIST ");
    cmd.append(key);
...
bool qRedis::pexpire(QString key, qint64 mseconds)
{
    QString cmd("PEXPIRE ");
    cmd.append(key);
...
bool qRedis::pexpireat(QString key, qint64 mstimestamp)
{
...
bool qRedis::rename(QString key, QString newkey)
{
    QString cmd("RENAME ");
    cmd.append(key);
...
bool qRedis::renamex(QString key, QString newkey)
{
    QString cmd("RENAMEX ");
    cmd.append(key);
...
bool qRedis::restore(QString key, int ttl, QString value)
{
    QString cmd("RESTORE ");
    cmd.append(key);
...
QString qRedis::rpop(QString key)
{
    QString cmd("RPOP ");
    cmd.append(key);
...
QString qRedis::rpoplpush(QString source, QString destination)
{
...
int qRedis::rpush(QString key, QString value)
{
    QString cmd("RPUSH ");
    cmd.append(key);
...
int qRedis::rpushx(QString key, QString value)
{
    QString cmd("RPUSHX ");
    cmd.append(key);
...
bool qRedis::sadd(QString key, QString member)
{
    QString cmd("SADD ");
    cmd.append(key);
...
QStringList qRedis::scriptexists(QString script)
{
...
QString qRedis::scriptload(QString script)
{
...
QStringList qRedis::sdiff(QString keys)
{
    QString cmd("SDIFF ");
    cmd.append(keys);
...
int qRedis::sdiffstore(QString destination, QString keys)
{
...
QStringList qRedis::sinter(QString keys)
{
    QString cmd("SINTER ");
    cmd.append(keys);
...
int qRedis::sinterstore(QString destination, QString keys)
{
...
bool qRedis::sismember(QString key, QString member)
{
...
QStringList qRedis::smembers(QString key)
{
...
bool qRedis::smove(QString source, QString destination, QString member)
{
    QString cmd("SMOVE ");
    cmd.append(source);
...
QString qRedis::spop(QString key)
{
    QString cmd("SPOP ");
    cmd.append(key);
...
QStringList qRedis::srandmember(QString key, int count)
{
...
int qRedis::srem(QString key, QString member)
{
    QString cmd("SREM ");
    cmd.append(key);
...
QStringList qRedis::sunion(QString keys)
{
    QString cmd("SUNION ");
    cmd.append(keys);
...
int qRedis::sunionstore(QString destination, QString keys)
{
...
int qRedis::setrange(QString key, int offset, QString value)
{
...
QStringList qRedis::sort(QString key, QString conditions)
{
    QString cmd("SORT ");
    cmd.append(key);
...
QString qRedis::type(QString key)
{
    QString cmd("TYPE ");
    cmd.append(key);
