/****************************************************************************
** Meta object code from reading C++ file 'qReader.h'
**
...
#error "The header file 'qReader.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Reader_t, stringdata) + ofs \
...
void Reader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Reader::response)) {
                *result = 0;
            }
        }
        {
            typedef void (Reader::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Reader::connected)) {
                *result = 1;
            }
        }
        {
            typedef void (Reader::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Reader::disconnected)) {
                *result = 2;
            }
        }
        {
            typedef void (Reader::*_t)(QAbstractSocket::SocketError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Reader::error)) {
                *result = 3;
            }
        }
    }
